#ifndef NOUR_BASE_CONFIG_H
#define NOUR_BASE_CONFIG_H

//uncomment the base you're building
#define NOUR_BASE DIFFERENTIAL_DRIVE // 2WD and Tracked robot w/ 2 motors
// #define NOUR_BASE SKID_STEER      // 4WD robot
// #define NOUR_BASE ACKERMANN       // Car-like steering robot w/ 2 motors
// #define NOUR_BASE ACKERMANN1      // Car-like steering robot w/ 1 motor
// #define NOUR_BASE MECANUM         // Mecanum drive robot
...
#define K_P 0.05 // 0.6 // P constant
#define K_I 0.9 // 0.3 // I constant
#define K_D 0.1 // 0.5 // D constant


//define your robot' specs here
#define MAX_RPM 83               // motor's maximum RPM
#define COUNTS_PER_REV 1600       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.145       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.41  // distance between left and right wheels
...
// RIGHT MOTOR2
#define MOTOR2_ENCODER_A 9 // 11
#define MOTOR2_ENCODER_B 10 // 12

#define MOTOR3_ENCODER_A 17
#define MOTOR3_ENCODER_B 16 

#define MOTOR4_ENCODER_A 11 
...
//MOTOR PINS
  ...
  // LEFT MOTOR1
  #define MOTOR1_PWM 21 //21
  #define MOTOR1_IN_A 1 //1
  #define MOTOR1_IN_B 20 //20
  // RIGHT MOTOR2
  #define MOTOR2_PWM 5 //5
  #define MOTOR2_IN_A 8 //8
  #define MOTOR2_IN_B 6 //6
